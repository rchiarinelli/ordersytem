 ...
 * 
 */
package br.com.valinorti.bootstrap;
...
public class StartTomcat {
	...
	public static void main(String[] args) throws ServletException, LifecycleException {
		...
		WebResourceRoot resources = new StandardRoot(
				ctx);resources.addPreResources(new DirResourceSet(resources,"/WEB-INF/classes",additionWebInfClasses.getAbsolutePath(),"/"));ctx.setResources(resources);
